...
<div id="nav" class="container">
    <div class="btn-group">
        ...
        <a type="button" class="btn btn-secondary" href="<?php $_SERVER['DOCUMENT_ROOT'];?>/pages/assignments.php">Assignments</a>
        ...
        <div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="<?php $_SERVER['DOCUMENT_ROOT'];?>/pages/assignments/db-project/login.php">Project 1</a>
